...
AnimUtil_AnimationTypes = {
    anim_selector = function(self, dt)
        ...
        if mCurAnim.particles then
            self.anim.type = AnimUtil_AnimationTypes.particle
        else
...
function AnimUtil.InitializeAnimationUtil(self)
    ...
    if self.anim.method then
        local mAnimData = _data[AnimUtil_AnimMethodT[self.anim.method]]
        ...
        self.anim.method_func = AnimUtil_AnimMethod[self.anim.method]
...
function AnimUtil.UpdateAnimations(self, dt)
    local sAnim = self.anim
    if sAnim and sAnim.method_func then
        sAnim.method_func(self, dt)
    end
