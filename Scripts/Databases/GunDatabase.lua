...
local mgp_shape_anim_enum =
{
	bone_animation = 1,
	pose_animation = 2,
	particle       = 3,
	--Debris that are attached to the bone
	debris         = 4,
	--Debris that are attached to the shape
	shape_debris   = 5,
	delay          = 6
}
	...
	["bdd9e357-35f7-4140-8b19-477abef20e0f"] = { --Browning .50 HMG
		server = {
			...
			projectile = {
				...
				effectOffset = sm.vec3.new(0, 0, 1.5),
				lifetime = 20.0,
				gravity = 10.0,
				friction = 0.003,
				explosionLevel = 4,
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(0.0, -0.08, -0.3),
								dir = sm.vec3.new(0, 0, 1),
								spread = 50,
								velocity = 2,
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(0.0, -0.08, -0.55),
								dir = sm.vec3.new(0, 0, 1),
								spread = 50,
								velocity = 2,
								uuid = sm.uuid.new("b2fbb673-aab7-4eef-bb69-c5913e8b17b8")
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(0.0, -0.21, -0.59),
								dir = sm.vec3.new(0, -1, 0),
								spread = 50,
								velocity = 2,
								uuid = sm.uuid.new("b2fbb673-aab7-4eef-bb69-c5913e8b17b8")
							},
							{type = mgp_shape_anim_enum.bone_animation, anims = {"Shots"}, start_value = 0.0, end_value = 1.0, time = 0.23}
						}
					},
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(-0.15, 0.02, -0.05),
								dir = sm.vec3.new(-1, 0, 0),
								spread = 50,
								velocity = 3,
								uuid = sm.uuid.new("b2fbb673-aab7-4eef-bb69-c5913e8b17b8")
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(0.0, -0.16, -0.13),
								dir = sm.vec3.new(0, -1, 0),
								spread = 50,
								velocity = 3,
								uuid = sm.uuid.new("b2fbb673-aab7-4eef-bb69-c5913e8b17b8")
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(0.0, -0.16, -0.4),
								dir = sm.vec3.new(0, -1, 0),
								spread = 50,
								velocity = 3,
								uuid = sm.uuid.new("b2fbb673-aab7-4eef-bb69-c5913e8b17b8")
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(0.0, -0.16, -0.5),
								dir = sm.vec3.new(0, -1, 0),
								spread = 50,
								velocity = 3,
								uuid = sm.uuid.new("b2fbb673-aab7-4eef-bb69-c5913e8b17b8")
				...
				animation_states = {
					shoot = {
						[1] = {
							...
							{
								type = mgp_shape_anim_enum.shape_debris,
								offset = sm.vec3.new(-0.05, 0.0, -0.57),
								dir = sm.vec3.new(-1, 0, 0),
								spread = 50,
								velocity = 3,
								uuid = sm.uuid.new("b2fbb673-aab7-4eef-bb69-c5913e8b17b8")
