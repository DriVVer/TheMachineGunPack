...
local mgp_tool_database =
{
				...
				[1] = {
					{
						...
						name_tp = "shoot_tp",
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 1.0, 0),
						fp_offset = sm.vec3.new(0.0, -0.3, 0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
						fp_offset = sm.vec3.new(-0.03, -0.38, 0.05),
				...
				[1] = {
					{
						...
						name_tp = "shoot_tp",
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 1.5, -0.14),
						fp_offset = sm.vec3.new(0.0, 0.5, 0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
						fp_offset = sm.vec3.new(0, -0.3, 0.05),
						tp_offset = sm.vec3.new(0, 0, 0),
						name_tp = "TommyShell",
						name_fp = "TommyShellFP",
						bone_name = "Shell"
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, 0.8, 0.05),
						apply_velocity = false
					},
					--[[{
						type = mgp_tool_anim_enum.particle,
		...
		animation = {
			...
			shoot =
			{
				[1] = {
					...
					{
						type = mgp_tool_anim_enum.bone_animation,
						fp_anim = { { name = "BAR_anims", start_val = 0.0, end_val = 0.2 } },
						tp_anim = { { name = "BAR_anims", start_val = 0.0, end_val = 0.2 } },
						time = 0.2
					}
				},
				[2] = {
			...
			aimShoot =
			{
				[1] = {
					...
					{
						type = mgp_tool_anim_enum.bone_animation,
						fp_anim = { { name = "BAR_anims", start_val = 0.0, end_val = 0.13 } },
						tp_anim = { { name = "BAR_anims", start_val = 0.0, end_val = 0.13 } },
						time = 0.13
					}
				},
				[2] = {
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, -0.2, 0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, -0.4, 0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
						fp_offset = sm.vec3.new(0, -0.6, 0),
						tp_offset = sm.vec3.new(0, 0, 0),
						name_tp = "TommyShell",
						name_fp = "TommyShellFP",
						bone_name = "jnt_slide"
				...
				[1] = {
					{
						...
						name_tp = "shoot_tp",
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.1, 0),
						fp_offset = sm.vec3.new(0.0, 0.1, 0.0125),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, -0.35, 0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
				...
				[1] = {
					{
						...
						name_tp = "shoot_tp",
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.35, 0),
						fp_offset = sm.vec3.new(0.0, -0.5, 0),
						apply_velocity = false
					},
					{
	...
	Shotgun =
	{
		dlm_required_effects = {
			...
			PumpIn = "DLM_Shotgun_PumpIn",
			PumpOut = "DLM_Shotgun_PumpOut",
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, -0.35, 0.0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
		...
		animation = {
			equip =
			{
				[1] = {
					{
						type = mgp_tool_anim_enum.bone_animation,
						fp_anim = { { name = "STG44_anims", start_val = 0.13, end_val = 0.13 } },
						tp_anim = { { name = "STG44_anims", start_val = 0.13, end_val = 0.13 } },
						time = 0.0
					}
				}
			},
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, -0.26, 0.0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, -0.44, 0),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.bone_animation,
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, 0.1, 0.04),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.bone_animation,
	...
	SW38 =
	{
		dlm_required_effects = {
			...
			open = "DLM_SW_Open",
			close = "DLM_SW_Close",
			roundsOut = "DLM_SW_RoundsOut",
			clipIn = "DLM_SW_ClipIn",
			cloth1 = "DLM_SW_Cloth_1",
			cloth2 = "DLM_SW_Cloth_2",
			cloth3 = "DLM_SW_Cloth_3"
		},
		required_effects = {
			shoot_tp = "Muzzle_Flash_SmallCal_fp",
			shoot_fp = "Muzzle_Flash_SmallCal_fp",
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, -0.7, 0),
						apply_velocity = false
					}
				},
				[2] = {
		...
		animation = {
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, 0.4, 0.03),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.bone_animation,
				...
				[2] = {
					{
						...
						name_fp = "gunshot",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0, 0.05, 0),
						apply_velocity = false
					}
				}
			},
			...
			reload_clip =
			{
				[1] = {
					{
						type = mgp_tool_anim_enum.bone_animation,
						fp_anim = { { name = "MosinNS_Anim", start_val = 2.5, end_val = 2.7 } },
						tp_anim = { { name = "MosinNS_Anim", start_val = 2.5, end_val = 2.5 } },
						time = 0.2
					},
					{
						type = mgp_tool_anim_enum.bone_animation,
						fp_anim = { { name = "MosinNS_Anim", start_val = 2.7, end_val = 4.5 } },
						tp_anim = { { name = "MosinNS_Anim", start_val = 2.7, end_val = 4.5 } },
						time = 1.8
					},
					{
						type = mgp_tool_anim_enum.nextAnimation,
				...
				[1] = {
					{
						...
						name_fp = "shoot_fp",
						tp_offset = sm.vec3.new(0, 0.5, 0),
						fp_offset = sm.vec3.new(0.0, 0.8, 0.1),
						apply_velocity = false
					},
					{
						type = mgp_tool_anim_enum.particle,
