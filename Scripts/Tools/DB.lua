...
function DB.loadAnimations( self )
	self.tpAnimations = createTpAnimations(
		self.tool,
		{
			shoot = { "spudgun_shoot1", { crouch = "spudgun_crouch_shoot" }, { nextAnimation = "idle", duration = 1.0 } },
			shoot_2 = { "spudgun_shoot2", { crouch = "spudgun_crouch_shoot" }, { nextAnimation = "idle", duration = 1.0 } },
